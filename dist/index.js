...
const compare = (metric, reference, value) => {
...
class GTMetrixClient {
    ...
    startTest(parameters) {
        return __awaiter(this, void 0, void 0, function* () {
            const { body } = yield this.client.post('tests', {
    ...
    getTest(testId) {
        return __awaiter(this, void 0, void 0, function* () {
            const { body } = yield this.client.get(`tests/${testId}`);
            return body;
        });
    }
}
...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            let test = yield gt_metrix_client_1.default.getTest(testId);
            yield p_wait_for_1.default(() => __awaiter(this, void 0, void 0, function* () {
            ...
            if (!configuration.requirements) {
                ...
                reportedAttributes.forEach((metric) => {
                    ...
                    const success = compare_1.compare(metric, reference, value);
                    metricsSuccess.push(success);
                    const rowConfig = reference === undefined ? { reference: '-', color: 'white' } : { reference, color: success ? 'green' : 'red' };
...
const console_table_printer_1 = __importDefault(__nccwpck_require__(8369));
exports.Table = console_table_printer_1.default;
const internal_table_printer_1 = __nccwpck_require__(2960);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const internal_table_1 = __importDefault(__nccwpck_require__(5159));
const table_helpers_1 = __nccwpck_require__(7205);
class Table {
    constructor(options) {
...
const table_constants_1 = __nccwpck_require__(8393);
...
const colored_console_line_1 = __importDefault(__nccwpck_require__(5702));
const string_utils_1 = __nccwpck_require__(8204);
const table_constants_1 = __nccwpck_require__(8393);
const table_helpers_1 = __nccwpck_require__(7205);
const internal_table_1 = __importDefault(__nccwpck_require__(5159));
const table_pre_processors_1 = __nccwpck_require__(2607);
// ║ Index ║         ║        ║
...
const table_constants_1 = __nccwpck_require__(8393);
const table_helpers_1 = __nccwpck_require__(7205);
const input_converter_1 = __nccwpck_require__(6319);
const internal_table_printer_1 = __nccwpck_require__(2960);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const simple_wcswidth_1 = __nccwpck_require__(9294);
...
const console_utils_1 = __importDefault(__nccwpck_require__(7285));
...
const wcswidth_1 = __importDefault(__nccwpck_require__(8717));
exports.wcswidth = wcswidth_1.default;
const wcwidth_1 = __importDefault(__nccwpck_require__(1665));
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const non_spacing_chars_1 = __importDefault(__nccwpck_require__(2288));
const binary_search_1 = __importDefault(__nccwpck_require__(3508));
